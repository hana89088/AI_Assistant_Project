...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Optimization: Open the microphone stream once outside the loop to eliminate
        # significant audio device initialization latency and prevent missed audio chunks.
