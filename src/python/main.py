...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # ⚡ Bolt Optimization: Keep microphone stream open instead of reopening in loop
        # What: Moved `with self.microphone` outside the while loop.
        # Why: Reopening the PyAudio stream on every iteration introduces significant latency.
        # Impact: Substantially reduces audio processing latency.
