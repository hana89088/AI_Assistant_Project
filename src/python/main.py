...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Optimize: Open the microphone stream once outside the loop
        # to avoid the significant latency overhead of continuously
        # opening and closing the PyAudio stream during each iteration.
