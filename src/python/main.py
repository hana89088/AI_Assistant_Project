...
class AIAssistant:
    ...
    async def broadcast(self, message):
        ...
        if self.clients:
            # ⚡ Bolt: Compute JSON serialization exactly once outside the broadcast loop
            # and use return_exceptions=True to prevent one client's error from failing others
