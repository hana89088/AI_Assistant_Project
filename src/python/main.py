...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Keep the microphone stream open continuously by moving the 'while' loop inside
        # the context manager. Previously, repeatedly opening/closing the audio stream
        # inside the loop caused severe latency and dropped audio chunks.
        # Expected Impact: Eliminates stream initialization overhead per iteration,
        # significantly reducing latency and ensuring gapless real-time voice processing.
