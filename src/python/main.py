...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Initializing PyAudio streams (`with self.microphone as source:`) is an expensive operation.
        # Moving the `while self.is_listening` loop inside the context manager
        # keeps the stream continuously open. This removes O(N) stream initialization overhead,
        # avoids dropping early audio frames, and significantly reduces latency between phrases.
