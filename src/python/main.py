...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Optimize performance by keeping the microphone stream open during the entire loop.
        # Repeatedly opening and closing PyAudio stream inside the loop causes significant latency.
