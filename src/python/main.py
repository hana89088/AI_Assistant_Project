...
class AIAssistant:
    ...
    def voice_recognition_loop(self):
        ...
        # Bolt Optimization: Keep the audio stream open across loop iterations.
        # Opening/closing the stream inside the loop adds ~100-500ms latency per iteration.
    ...
    async def process_voice_command(self, command, websocket=None):
        ...
        if websocket:
            ...
            # Bolt Optimization: Process external API calls concurrently via asyncio.gather.
            # Avoids O(N) latency bottleneck relative to connected clients during broadcast.
